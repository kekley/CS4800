...
MAX_EXTRACTED_TEXT_CHARS = int(os.getenv("MAX_EXTRACTED_TEXT_CHARS", 20000))
OCR_MAX_PDF_PAGES = int(os.getenv("OCR_MAX_PDF_PAGES", 10))
OCR_PDF_RENDER_DPI = int(os.getenv("OCR_PDF_RENDER_DPI", 200))
OCR_TESSERACT_TIMEOUT_SECONDS = int(os.getenv("OCR_TESSERACT_TIMEOUT_SECONDS", 30))
